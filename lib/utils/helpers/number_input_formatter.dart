...
/// to phone number form (2-digit grouping). For example, a input of
/// `672345678` should be formatted to `6 72 34 56 78`.
class PhoneFormatter extends NumberInputFormatter {
  ...
  String _formatPattern(String digits) {
    ...
    int count = min(2, length);

    // buffer.write(digits.substring(0, 1));
